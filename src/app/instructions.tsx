...
export const Instructions = () => (
  <ThemeProvider theme={mainTheme}>
    <Box
      ...
      <Typography variant="h1">Date Night</Typography>
      <Typography variant="body1">
        Running out of ideas for dates? Just want to imagine what it&apos;s like going on a date?
        Use this tool to find something new!
      </Typography>
    </Box>
  </ThemeProvider>
);
